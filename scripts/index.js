...
//								clearCanvas: true;
						...
						anim.addEventListener("DOMLoaded", function() {
							...
							anim.renderer.elements[5].elements[3].elements[1].innerElem.href.baseVal = ratingSort[1].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[5].elements[5].elements[1].innerElem.href.baseVal = ratingSort[1].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[5].elements[13].elements[1].innerElem.href.baseVal = ratingSort[1].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[5].elements[15].updateDocumentData({t:ratingSort[1].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[5].elements[17].elements[1].innerElem.href.baseVal = ratingSort[1].profile_picture;			// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[7].elements[3].elements[1].innerElem.href.baseVal = ratingSort[2].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[7].elements[5].elements[1].innerElem.href.baseVal = ratingSort[2].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[7].elements[13].elements[1].innerElem.href.baseVal = ratingSort[2].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[7].elements[15].updateDocumentData({t:ratingSort[2].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[7].elements[17].elements[1].innerElem.href.baseVal = ratingSort[2].profile_picture;			// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[9].elements[3].elements[1].innerElem.href.baseVal = ratingSort[3].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[9].elements[5].elements[1].innerElem.href.baseVal = ratingSort[3].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[9].elements[13].elements[1].innerElem.href.baseVal = ratingSort[3].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[9].elements[15].updateDocumentData({t:ratingSort[3].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[9].elements[17].elements[1].innerElem.href.baseVal = ratingSort[3].profile_picture;			// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[10].elements[3].elements[1].innerElem.href.baseVal = ratingSort[4].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[10].elements[5].elements[1].innerElem.href.baseVal = ratingSort[4].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[10].elements[13].elements[1].innerElem.href.baseVal = ratingSort[4].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[10].elements[15].updateDocumentData({t:ratingSort[4].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[10].elements[17].elements[1].innerElem.href.baseVal = ratingSort[4].profile_picture;			// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[12].elements[3].elements[1].innerElem.href.baseVal = ratingSort[5].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[12].elements[5].elements[1].innerElem.href.baseVal = ratingSort[5].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[12].elements[13].elements[1].innerElem.href.baseVal = ratingSort[5].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[12].elements[15].updateDocumentData({t:ratingSort[5].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[12].elements[17].elements[1].innerElem.href.baseVal = ratingSort[5].profile_picture;			// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[14].elements[3].elements[1].innerElem.href.baseVal = ratingSort[6].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[14].elements[5].elements[1].innerElem.href.baseVal = ratingSort[6].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[14].elements[13].elements[1].innerElem.href.baseVal = ratingSort[6].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[14].elements[15].updateDocumentData({t:ratingSort[6].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[14].elements[17].elements[1].innerElem.href.baseVal = ratingSort[6].profile_picture;			// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[15].elements[3].elements[1].innerElem.href.baseVal = ratingSort[7].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[15].elements[5].elements[1].innerElem.href.baseVal = ratingSort[7].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[15].elements[13].elements[1].innerElem.href.baseVal = ratingSort[7].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[15].elements[15].updateDocumentData({t:ratingSort[7].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[15].elements[17].elements[1].innerElem.href.baseVal = ratingSort[7].profile_picture;			// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[18].elements[3].elements[1].innerElem.href.baseVal = ratingSort[8].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[18].elements[5].elements[1].innerElem.href.baseVal = ratingSort[8].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[18].elements[13].elements[1].innerElem.href.baseVal = ratingSort[8].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[18].elements[15].updateDocumentData({t:ratingSort[8].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[18].elements[17].elements[1].innerElem.href.baseVal = ratingSort[8].profile_picture;			// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[21].elements[3].elements[1].innerElem.href.baseVal = ratingSort[9].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[21].elements[5].elements[1].innerElem.href.baseVal = ratingSort[9].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[21].elements[13].elements[1].innerElem.href.baseVal = ratingSort[9].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[21].elements[15].updateDocumentData({t:ratingSort[9].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[21].elements[17].elements[1].innerElem.href.baseVal = ratingSort[9].profile_picture;				// 17 - Profile_Holder 1 - PNG
							...
							anim.renderer.elements[23].elements[3].elements[1].innerElem.href.baseVal = ratingSort[10].away_club_logo;				// 3 - #ClubLogo 3 1 - PNG
							anim.renderer.elements[23].elements[5].elements[1].innerElem.href.baseVal = ratingSort[10].home_club_logo;				// 5 - #ClubLogo 2 1 - PNG
							...
							anim.renderer.elements[23].elements[13].elements[1].innerElem.href.baseVal = ratingSort[10].club_logo_url;				// 13 - #ClubLogo 1 - PNG
							anim.renderer.elements[23].elements[15].updateDocumentData({t:ratingSort[10].localized_abbreviation}); 					// 15 - #Position
							anim.renderer.elements[23].elements[17].elements[1].innerElem.href.baseVal = ratingSort[10].profile_picture;			// 17 - Profile_Holder 1 - PNG
							// 27-37 AE Layers 
							// 0 - #Position
							// 2 - #ClubName
							// 3 - #Name
							...
							anim.renderer.elements[27].elements[4].elements[1].innerElem.href.baseVal = mrData.player01.club_logo_url; // #ClubLogo
							anim.renderer.elements[27].elements[7].elements[1].innerElem.href.baseVal = mrData.player01.profile_picture; // Profile_Holder
							// PLAYER 02 //
							...
							anim.renderer.elements[28].elements[4].elements[1].innerElem.href.baseVal = mrData.player02.club_logo_url; // #ClubLogo
							anim.renderer.elements[28].elements[7].elements[1].innerElem.href.baseVal = mrData.player02.profile_picture; // Profile_Holder
							// PLAYER 03 //
							...
							anim.renderer.elements[29].elements[4].elements[1].innerElem.href.baseVal = mrData.player03.club_logo_url; // #ClubLogo
							anim.renderer.elements[29].elements[7].elements[1].innerElem.href.baseVal = mrData.player03.profile_picture; // Profile_Holder
							// PLAYER 04 //
							...
							anim.renderer.elements[30].elements[4].elements[1].innerElem.href.baseVal = mrData.player04.club_logo_url; // #ClubLogo
							anim.renderer.elements[30].elements[7].elements[1].innerElem.href.baseVal = mrData.player04.profile_picture; // Profile_Holder
							// PLAYER 05 //
							...
							anim.renderer.elements[31].elements[4].elements[1].innerElem.href.baseVal = mrData.player05.club_logo_url; // #ClubLogo
							anim.renderer.elements[31].elements[7].elements[1].innerElem.href.baseVal = mrData.player05.profile_picture; // Profile_Holder
							// PLAYER 06 //
							...
							anim.renderer.elements[32].elements[4].elements[1].innerElem.href.baseVal = mrData.player06.club_logo_url; // #ClubLogo
							anim.renderer.elements[32].elements[7].elements[1].innerElem.href.baseVal = mrData.player06.profile_picture; // Profile_Holder
							// PLAYER 07 //
							...
							anim.renderer.elements[33].elements[4].elements[1].innerElem.href.baseVal = mrData.player07.club_logo_url; // #ClubLogo
							anim.renderer.elements[33].elements[7].elements[1].innerElem.href.baseVal = mrData.player07.profile_picture; // Profile_Holder
							// PLAYER 08 //
							...
							anim.renderer.elements[34].elements[4].elements[1].innerElem.href.baseVal = mrData.player08.club_logo_url; // #ClubLogo
							anim.renderer.elements[34].elements[7].elements[1].innerElem.href.baseVal = mrData.player08.profile_picture; // Profile_Holder
							// PLAYER 09 //
							...
							anim.renderer.elements[35].elements[4].elements[1].innerElem.href.baseVal = mrData.player09.club_logo_url; // #ClubLogo
							anim.renderer.elements[35].elements[7].elements[1].innerElem.href.baseVal = mrData.player09.profile_picture; // Profile_Holder
							// PLAYER 10 //
							...
							anim.renderer.elements[36].elements[4].elements[1].innerElem.href.baseVal = mrData.player10.club_logo_url; // #ClubLogo
							anim.renderer.elements[36].elements[7].elements[1].innerElem.href.baseVal = mrData.player10.profile_picture; // Profile_Holder
							...
							anim.renderer.elements[37].elements[4].elements[1].innerElem.href.baseVal = mrData.player11.club_logo_url; // #ClubLogo
							anim.renderer.elements[37].elements[7].elements[1].innerElem.href.baseVal = mrData.player11.profile_picture; // Profile_Holder
